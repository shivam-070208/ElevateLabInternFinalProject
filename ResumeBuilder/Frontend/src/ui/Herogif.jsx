...
const Herogif = () => {
  return (
    <div className="w-[40vw] h-[40vw]  min-w-70 min-h-140 rounded-full relative will-change-transform  bg-gradient-to-tl from-[#f90000] via-[#0051ffde] animate-pulse  blur-lg    origin-center  ">
